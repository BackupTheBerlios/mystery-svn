<?php
/**
* @version $Id: admin.banners.php,v 1.11 2004/09/16 09:48:24 stingrey Exp $
* @package Mambo_4.5.1
...
function editBanner( $bannerid, $option ) {
  ...
  $lists['showBanner'] = mosHTML::selectList( $yesno, 'showBanner', "class=\"inputbox\" size=\"1\"" ,
	'value', 'text', $row->showBanner );
