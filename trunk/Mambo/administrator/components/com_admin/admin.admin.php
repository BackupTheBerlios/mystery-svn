<?php
/**
* @version $Id: admin.admin.php,v 1.9 2004/09/06 05:02:55 eddieajau Exp $
* @package Mambo_4.5.1
...
switch ($task) {
	...
	case "redirect":
		...
		if ($goto == "null"){
			mosRedirect("index2.php?option=com_admin&task=listcomponents","There is no link associated with this item");
			exit();
		}
