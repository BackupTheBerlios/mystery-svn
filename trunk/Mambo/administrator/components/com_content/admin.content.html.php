<?php
/**
* @version $Id: admin.content.html.php,v 1.86 2004/09/29 15:54:32 saka Exp $
* @package Mambo_4.5.1
		...
		<tr>
			...
			<td valign="top" width="40%">
				...
				<tr>
					...
					<tr>
						<td>
						<input type="button" class="button" value="Add Sect/Cat/Title" onClick="f=document.adminForm;f.metakey.value='<?php echo $sec; ?>, '+getSelectedText('adminForm','catid')+', '+f.title.value+f.metakey.value;" />
						</td>
					</tr>
					</table>
					<?php
