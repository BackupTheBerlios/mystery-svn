<?php
/**
* @version $Id: admin.content.php,v 1.62 2004/09/29 15:54:32 saka Exp $
* @package Mambo_4.5.1
...
function editContent( $uid=0, $sectionid=0, $option ) {
	...
	HTML_content::editContent( $row, $section, $lists, $sectioncategories, $images, $my->id, $params, $option, $redirect, $menus );
}
...
function saveContent( $sectionid, $option ) {
	...
	$msg = $row->title .' successfully Saved';
...
function resethits() {
	...
	$redirect = mosGetParam( $_POST, 'redirect', $sectionid );
	$msg = 'Successfully Reset Hit count for: '. $row->title;
