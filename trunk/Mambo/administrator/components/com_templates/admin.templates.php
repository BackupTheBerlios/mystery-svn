<?php
/**
* @version $Id: admin.templates.php,v 1.35 2004/09/06 03:44:37 eddieajau Exp $
* @package Mambo_4.5.1
...
function saveTemplateSource( $option, $client ) {
	...
	if ( is_writable( $file ) == false ) {
		mosRedirect( 'index2.php?option='. $option , '&mosmsg=Operation failed: '. $file .' is not writable.' );
	}
