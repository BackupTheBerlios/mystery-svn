<?php
/**
* @version $Id: content_blog_section.menu.html.php,v 1.25 2004/09/23 23:57:38 stingrey Exp $
* @package Mambo_4.5.1
...
* property set to 0.
* @package Mambo_4.5.1
* @param mosContent The section object
*/
...
function edit( &$menu, &$lists, &$params, $option ) {
	...
	<tr>
		<th>
		<?php echo $menu->id ? 'Edit' : 'Add';?> Menu Item :: Blog - Content Section Multiple
		</th>
	</tr>
	</table>
