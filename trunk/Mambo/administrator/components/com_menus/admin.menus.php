<?php
/**
* @version $Id: admin.menus.php,v 1.38 2004/09/22 20:47:57 stingrey Exp $
* @package Mambo_4.5.1
...
function moveMenuSave( $option, $cid, $menu, $menutype ) {
	...
	$msg = $total .' Menu Items moved to '. $menu;
	mosRedirect( 'index2.php?option='. $option .'&menutype='. $menutype .'&mosmsg='. $msg );
}
...
function copyMenuSave( $option, $cid, $menu, $menutype ) {
	...
	$msg = $total .' Menu Items Copied to '. $menu;
	mosRedirect( 'index2.php?option='. $option .'&menutype='. $menutype .'&mosmsg='. $msg );
}
...
function RenameMenu( &$type, $component=-1 ) {
	switch ( $type ) {
		...
		case 'content_section';
			$name = 'List - Content Section';
			break;

		case 'content_category';
			$name = 'Table - Content Category';
			break;
		...
		case 'content_blog_category';
			$name = 'Blog - Content Category';
			break;

		case 'content_blog_category_multi';
			$name = 'Blog - Content Category Multiple';
			break;

		case 'content_archive_section';
			$name = 'Blog - Content Section Archive';
			break;

		case 'content_archive_category';
			$name = 'Blog - Content Category Archive';
			break;

		case 'contact_category_table';
			$name = 'Table - Contact Category';
			break;

		case 'weblink_category_table';
			$name = 'Table - Weblink Category';
			break;

		case 'newsfeed_category_table';
			$name = 'Table - Newsfeed Category';
			break;
